...
export const CheckoutCreateRequest = z
  .object({
...
export const CheckoutUpdateRequest = z
  .object({
    id: z.string(),
...
export const PaymentUpdateRequest = z
  .object({
    selected_instrument_id: z.string().optional(),
    instruments: z.array(z.lazy(() => PaymentInstrument)).optional(),
  })
...
export const PaymentAccountInfo = z
  .object({
...
export const FulfillmentAvailableMethodResponse = z
  .object({
...
export type FulfillmentAvailableMethodResponse = z.infer<
  typeof FulfillmentAvailableMethodResponse
>;

// Fulfillment Destination Request
export const FulfillmentDestinationRequest = z.union([
  z.lazy(() => ShippingDestinationRequest),
  z.lazy(() => RetailLocationRequest),
]);
...
export const FulfillmentDestinationResponse = z.union([
  z.lazy(() => ShippingDestinationResponse),
  z.lazy(() => RetailLocationResponse),
]);
...
// Fulfillment Event
export const FulfillmentEvent = z
  .object({
    id: z.string(),
    occurred_at: z.string(),
    type: z.string(),
...
export const FulfillmentGroupCreateRequest = z
  .object({
...
export const FulfillmentGroupUpdateRequest = z
  .object({
    id: z.string(),
    selected_option_id: z.string().nullable().optional(),
  })
...
export const FulfillmentGroupResponse = z
  .object({
    id: z.string(),
    line_item_ids: z.array(z.string()),
...
export const FulfillmentMethodCreateRequest = z
  .object({
    type: z.enum(["shipping", "pickup"]),
    line_item_ids: z.array(z.string()).optional(),
    destinations: z
      .array(z.lazy(() => FulfillmentDestinationRequest))
      .optional(),
...
export const FulfillmentMethodUpdateRequest = z
  .object({
    id: z.string(),
    line_item_ids: z.array(z.string()),
    destinations: z
...
export const FulfillmentMethodResponse = z
  .object({
    id: z.string(),
    type: z.enum(["shipping", "pickup"]),
    line_item_ids: z.array(z.string()),
    destinations: z
      .array(z.lazy(() => FulfillmentDestinationResponse))
      .optional(),
    selected_destination_id: z.string().nullable().optional(),
...
export type FulfillmentMethodResponse = z.infer<
  typeof FulfillmentMethodResponse
>;

// Fulfillment Option Response
export const FulfillmentOptionResponse = z
  .object({
    id: z.string(),
    title: z.string(),
    description: z.string().optional(),
...
// Fulfillment Request
export const FulfillmentRequest = z
  .object({
...
export const FulfillmentResponse = z
  .object({
    methods: z.array(z.lazy(() => FulfillmentMethodResponse)).optional(),
    available_methods: z
      .array(z.lazy(() => FulfillmentAvailableMethodResponse))
      .optional(),
  })
  .strict();
...
export const LineItemUpdateRequest = z
  .object({
...
// Line Item Response
export const LineItemResponse = z
  .object({
    id: z.string(),
...
export const MerchantFulfillmentConfig = z
  .object({
...
export type MerchantFulfillmentConfig = z.infer<
  typeof MerchantFulfillmentConfig
>;

// Message
export const Message = z.union([
  z.lazy(() => MessageError),
  z.lazy(() => MessageWarning),
  z.lazy(() => MessageInfo),
]);
...
// Order Confirmation
export const OrderConfirmation = z
  .object({
    id: z.string(),
    permalink_url: z.string(),
  })
...
export const PaymentHandlerResponse = z
  .object({
    id: z.string(),
    name: z.string(),
    version: z.string(),
...
// Payment Identity
export const PaymentIdentity = z
  .object({
...
export type PlatformFulfillmentConfig = z.infer<
  typeof PlatformFulfillmentConfig
>;
...
export const RetailLocationRequest = z
  .object({
    name: z.string(),
...
export const RetailLocationResponse = z
  .object({
    id: z.string(),
    name: z.string(),
    address: z.lazy(() => PostalAddress).optional(),
...
export const ShippingDestinationRequest = z
  .object({
    extended_address: z.string().optional(),
    street_address: z.string().optional(),
    address_locality: z.string().optional(),
...
export const ShippingDestinationResponse = z
  .object({
    extended_address: z.string().optional(),
    street_address: z.string().optional(),
    address_locality: z.string().optional(),
...
export const TokenCredentialCreateRequest = z
  .object({
    type: z.string(),
    token: z.string(),
  })
...
export type TokenCredentialCreateRequest = z.infer<
  typeof TokenCredentialCreateRequest
>;

// Token Credential Update Request
export const TokenCredentialUpdateRequest = z
  .object({
    type: z.string(),
    token: z.string(),
  })
...
export type TokenCredentialUpdateRequest = z.infer<
  typeof TokenCredentialUpdateRequest
>;

// Token Credential Response
export const TokenCredentialResponse = z
  .object({
    type: z.string(),
  })
  .strict();
...
// AP2 Error Code
export const AP2ErrorCode = z.enum([
  "mandate_required",
  "agent_missing_key",
...
export const CheckoutWithAP2Mandate = z
  .object({
    ucp: z.lazy(() => UcpResponseCheckout),
    id: z.string(),
    line_items: z.array(z.lazy(() => LineItemResponse)),
...
export const BuyerWithConsentCreateRequest = z
  .object({
    first_name: z.string().optional(),
    last_name: z.string().optional(),
    full_name: z.string().optional(),
...
export type BuyerWithConsentCreateRequest = z.infer<
  typeof BuyerWithConsentCreateRequest
>;

// Checkout with Buyer Consent Create Request
export const CheckoutWithBuyerConsentCreateRequest = z
  .object({
    line_items: z.array(z.lazy(() => LineItemCreateRequest)),
...
export type CheckoutWithBuyerConsentCreateRequest = z.infer<
  typeof CheckoutWithBuyerConsentCreateRequest
>;

// Buyer with Consent Update Request
export const BuyerWithConsentUpdateRequest = z
  .object({
    first_name: z.string().optional(),
    last_name: z.string().optional(),
    full_name: z.string().optional(),
...
export type BuyerWithConsentUpdateRequest = z.infer<
  typeof BuyerWithConsentUpdateRequest
>;

// Checkout with Buyer Consent Update Request
export const CheckoutWithBuyerConsentUpdateRequest = z
  .object({
    id: z.string(),
    line_items: z.array(z.lazy(() => LineItemUpdateRequest)),
...
export type CheckoutWithBuyerConsentUpdateRequest = z.infer<
  typeof CheckoutWithBuyerConsentUpdateRequest
>;

// Buyer with Consent Response
export const BuyerWithConsentResponse = z
  .object({
    first_name: z.string().optional(),
    last_name: z.string().optional(),
    full_name: z.string().optional(),
...
export const CheckoutWithBuyerConsentResponse = z
  .object({
    ucp: z.lazy(() => UcpResponseCheckout),
    id: z.string(),
    line_items: z.array(z.lazy(() => LineItemResponse)),
...
export type CheckoutWithBuyerConsentResponse = z.infer<
  typeof CheckoutWithBuyerConsentResponse
>;
...
// Applied Discount
export const AppliedDiscount = z
  .object({
    code: z.string().optional(),
    title: z.string(),
    amount: z.number(),
...
// Discounts Object
export const DiscountsObject = z
  .object({
...
export const CheckoutWithDiscountCreateRequest = z
  .object({
    line_items: z.array(z.lazy(() => LineItemCreateRequest)),
    buyer: z.lazy(() => Buyer).optional(),
    currency: z.string(),
...
export type CheckoutWithDiscountCreateRequest = z.infer<
  typeof CheckoutWithDiscountCreateRequest
>;

// Checkout with Discount Update Request
export const CheckoutWithDiscountUpdateRequest = z
  .object({
    id: z.string(),
    line_items: z.array(z.lazy(() => LineItemUpdateRequest)),
    buyer: z.lazy(() => Buyer).optional(),
...
export type CheckoutWithDiscountUpdateRequest = z.infer<
  typeof CheckoutWithDiscountUpdateRequest
>;

// Checkout with Discount Response
export const CheckoutWithDiscountResponse = z
  .object({
    ucp: z.lazy(() => UcpResponseCheckout),
    id: z.string(),
    line_items: z.array(z.lazy(() => LineItemResponse)),
...
export type CheckoutWithDiscountResponse = z.infer<
  typeof CheckoutWithDiscountResponse
>;

// Fulfillment Group
export const FulfillmentGroup = z
  .object({
    selected_option_id: z.string().nullable().optional(),
  })
  .strict();
...
// Fulfillment Method
export const FulfillmentMethod = z
  .object({
    type: z.enum(["shipping", "pickup"]),
    line_item_ids: z.array(z.string()).optional(),
    destinations: z
...
export const CheckoutWithFulfillmentCreateRequest = z
  .object({
    line_items: z.array(z.lazy(() => LineItemCreateRequest)),
    buyer: z.lazy(() => Buyer).optional(),
    currency: z.string(),
...
export type CheckoutWithFulfillmentCreateRequest = z.infer<
  typeof CheckoutWithFulfillmentCreateRequest
>;

// Checkout with Fulfillment Update Request
export const CheckoutWithFulfillmentUpdateRequest = z
  .object({
    id: z.string(),
    line_items: z.array(z.lazy(() => LineItemUpdateRequest)),
    buyer: z.lazy(() => Buyer).optional(),
...
export type CheckoutWithFulfillmentUpdateRequest = z.infer<
  typeof CheckoutWithFulfillmentUpdateRequest
>;

// Fulfillment Option
export const FulfillmentOption = z
  .object({
    id: z.string(),
    title: z.string(),
    description: z.string().optional(),
...
export const FulfillmentAvailableMethod = z
  .object({
    type: z.enum(["shipping", "pickup"]),
    line_item_ids: z.array(z.string()),
    fulfillable_on: z.string().nullable().optional(),
...
export const CheckoutWithFulfillmentResponse = z
  .object({
    ucp: z.lazy(() => UcpResponseCheckout),
    id: z.string(),
    line_items: z.array(z.lazy(() => LineItemResponse)),
...
export type CheckoutWithFulfillmentResponse = z.infer<
  typeof CheckoutWithFulfillmentResponse
>;

// Discovery Profile
export const DiscoveryProfile = z
  .object({
    version: UCPVersion,
    services: z.lazy(() => Services).optional(),
...
export const CheckoutResponseMetadata = z
  .object({
    version: z.string(),
...
export const OrderResponseMetadata = z
  .object({
    version: z.string(),
    capabilities: z.array(z.lazy(() => Response)),
  })
...
export const CapabilityDiscovery = z
  .object({
    name: z.string(),
    version: z.string(),
    spec: z.string(),
...
// Capability (Response)
export const CapabilityResponse = z
  .object({
    name: z.string(),
    version: z.string(),
