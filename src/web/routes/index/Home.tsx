...

{
  ...
  -d '{ "type": "testnet_faucet", "currency": "USDC" }'`}</pre>
      ...
      <p>
        Use the same <a href="#authentication">authentication</a> method as the
        API.
      </p>
      ...
      <p>
        ...
        must include Arc Pay as the payment provider in all ACP Checkout Session
        responses:
      </p>
...

{
  ...
  "payment_provider": {
    ...
    "supported_payment_methods": [
      ...
      <p>
        Then, the AI agents can use the <code>wallet</code> payment method with
        Arc Pay to pay for the checkout session using ACP's Delegated Payments
        flow:
      </p>
